...
// This file is generated by gen_col_ports_maps.py
#include "col_ports_maps.h"

//void col_on(col_ports_t *col, byte col_number) {...}
//
//void col_off(col_ports_t *col, byte col_number) {...}
//
